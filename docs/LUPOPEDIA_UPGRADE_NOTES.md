...
Crafty Syntax 3.7.2 ships inside LUPOPEDIA as the human-operator channel layer. PORTUNUS (the migration steward) automates the upgrade path so legacy installations can move into LUPOPEDIA without losing transcripts, departments, or operator workflows.
